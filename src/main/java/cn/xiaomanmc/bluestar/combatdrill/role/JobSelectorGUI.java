...
public class JobSelectorGUI {
    ...
    public int select(Gamer gamer) {
        ...
        Inventory selectInv = Bukkit.createInventory(gamer.getMcPlayer(), 6 * 9, guiTitle);
        ...
        for (int column: mainGunColumn) {
            selectInv.setItem(column + 9, mainGunColumnHead);
        }
